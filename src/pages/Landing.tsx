      ...
      <main className="flex-grow">
        ...
        <section className="py-20 md:py-28 px-4 sm:px-6 max-w-5xl mx-auto text-center flex flex-col items-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-800 font-bold text-sm mb-6 shadow-sm"
          >
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-brand-800 to-brand-600">
              AI 취업 코파일럿.
            </span>
          </motion.h1>
          ...
          >
            <button
              ...
              className="bg-brand-600 hover:bg-brand-700 text-white px-8 py-4 rounded-2xl font-bold text-base transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2.5 active:scale-98"
            >
              <Database size={20} />
        ...
        <section className="py-12 md:py-16 px-4 sm:px-6 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
              <div className="w-12 h-12 rounded-2xl bg-brand-600 text-white flex items-center justify-center mb-6 shadow-sm">
                <GitMerge size={24} />
              </div>
