...
Write every "question" and "expected_answer_hint" ENTIRELY in Korean. Do not switch to
English, Spanish, or any other language for individual words or phrases mid-sentence —
every word must be Korean.
